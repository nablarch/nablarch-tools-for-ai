# Nablarch 入力値検証 (Bean Validation) 実装ガイド

NablarchはJakarta Bean Validationに準拠したバリデーション機能を提供します。
...
// 使用例
@SystemChar(charsetDef = "数字", groups = {Default.class, ValidationGroup.Create.class})
